...
const Report = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    setShowDeleteConfirmation(false);
    try {
      const res = await axios.post(`${BASEURL}/report/deleteReportWithId`,{crId: delId});
  ...
  const getCampReportInfoWithId = async(crid)=>{
    try {
      const res = await axios.post(`${BASEURL}/report/getReportInfoWithId`,{crId:crid});
  ...
  const getCampReportImages = async(crid)=>{
    try {
      const res = await axios.post(`${BASEURL}/report/getImages`,{crId:crid});
       if(res?.status === 200){
  ...
  const getCampRequestList = async()=>{
    try {
      const res = await axios.post(`${BASEURL}/campRequest/getApprovedCampRequest`,
      {userId: userId}
    );
  ...
  const handleAddSubmit = async () => {
    ...
    try {
      ...
      const reportResponse = await axios.post(`${BASEURL}/report/addReportWithInfo`, {
        campTypeId: campType,
        repId: repId,
        docId: doctorId,
        pathLabId: pathlab,
      ...
      if (reportResponse?.data?.errorCode === "1") {
       ...
       // alert("Camp Report Added Successfully");
        ...
        try {
          ...
          const imageUploadResponse = await axios.post(`${BASEURL}/report/uploadImages`, formData, {
            headers: {
 ...
 const handleEdit = async (campReportId) => {
      ...
      try {
        ...
        const response = await axios.post(`${BASEURL}/report/getReportInfoWithId`, {
          crId : campReportId
        });
...
const handelDeleteCampImage = async(imgid)=>{
  try {
    const res = await axios.post(`${BASEURL}/report/deleteSingalImg`,{crimgid:imgid});
    if(res?.data?.errorCode == "1"){
...
const handelCampRequestChange = (event)=>{
  ...
  const requestData = campRequestList.find((camp)=>camp.camp_req_id == event.target.value);
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <form className="row g-3">
                    ...
                    <div className="form-group col-md-4">
                      <label className="form-label">Prescription Generated</label>
                      <input
                        type="number"
                        className="form-control"
                    ...
                    <div>Camp Images</div>
                      ...
                      <div className="form-row flex">
                        ...
                        campImages.map((img)=>(
                          <img key={img.crimgid} className="campimage" crossOrigin="anonymous" src={`${BASEURL}/uploads/report/${img.imgpath}`}></img>
                        ))
                        }
                      </div>
                  </form>
        ...
        <div className="addusermodel">
          ...
          >
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                 ...
                 <form className="row g-3">
                  ...
                  <div className="form-group col-md-4">
                      <label className="form-label">Select Camp Request</label>
                        ...
                        >
                          ...
                          {campRequestList.map((e)=>(
                            <option key={e.camp_req_id} value={e.camp_req_id}>{e.camp_date1}-{e.camp_venue}</option>
                          ))}
                        </select>
                    </div>
                  <div className="form-group col-md-4">
                  ...
                  <form className="row g-3" >
                     ...
                     <div className="form-group col-md-4">
                      <label className="form-label">No. of Patients Screened</label>
                      <input
                        type="number"
                        className="form-control"
                        onChange={(e)=>{
                    ...
                    <div className="form-group col-md-4">
                      <label className="form-label">No. of Patients Diagnosed</label>
                      <input
                        type="number"
                        className="form-control"
                        onChange={(e)=>{
                    ...
                    <div className="form-group col-md-4">
                      <label className="form-label">No. of Prescription Generated</label>
                      <input
                        type="number"
                        className="form-control"
                        onChange={(e)=>{
                  ...
                  <div className="form-group col-md-4">
                    <label className="form-label"> Upload Camp Images</label> <br />
                      <input type="file" 
                      accept="image/*"
                      multiple
            ...
            <div key={index} style={{ position: 'relative', display: 'inline-block' }}>
              <img src={url} alt="Preview" style={{ width: '100px', height:'130px'}} />
              <button
                type="button"
              ...
              >
                X
                  ...
                  {currentIndex === 1? <div className="text-center">
                  ...
                  <div className="text-center">
                    <button type="button" className="btn btn-success mx-auto mt-1"
                    onClick={handlePrevious}
                    >
                      Previous
                    </button>
                    <button type="button" className="btn btn-success mx-auto ml-1 mt-1"
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  <div style={{ display: 'flex', gap: '10px', marginTop: '10px' }}>
                      ...
                      {campImages && campImages.length>0 && campImages.map((img) => (
                        <div key={img.crimgid} style={{ position: 'relative', display: 'inline-block' }}>
                          <img crossOrigin="anonymous" src={`${BASEURL}/uploads/report/${img.imgpath}`} alt="Report Image" style={{ width: '100px', height:'130px'}} />
                          <button
                            type="button"
